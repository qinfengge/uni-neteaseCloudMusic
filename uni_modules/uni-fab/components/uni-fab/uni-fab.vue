<template>
	<view class="uni-cursor-point" :style="{display: styles.display}">
		...
		<view :class="{
		  ...
		  'uni-fab__content--other-platform': !isAndroidNvue
		}" class="uni-fab__circle uni-fab__plus" :style="{ 'background-color': styles.buttonColor, 'bottom': nvueBottom, 'background-image': 'url('+ styles.backgroundImage +')' }" @click="_onClick">
		...
		data() {
			return {
				...
				styles: {
					...
					backgroundColor: '#726d7f',
					buttonColor: '#007AFF',
					iconColor: '#fff',
					backgroundImage: '../../../../static/163logo.png',
					display: 'none'
				},
				key: 0
			}
